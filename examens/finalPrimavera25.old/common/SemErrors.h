...
public:
  ...
  //   ctx is the node corresponding to the secure/second expression 
  void inCompatibleSecureAccessExpression(antlr4::ParserRuleContext *ctx);
  //   ctx is the node corresponding to zip instruction
  void incompatibleArgumentsInZip(antlr4::ParserRuleContext *ctx);
