...
std::any TypeCheckVisitor::visitPairAccessExpr(AslParser::PairAccessExprContext *ctx) {
    DEBUG_ENTER();
    visit(ctx->pair());
    TypesMgr::TypeId t = getTypeDecor(ctx->pair());
    putTypeDecor(ctx, t);
    DEBUG_EXIT();
    return 0;
}

std::any TypeCheckVisitor::visitPairAccesLeftExpr(AslParser::PairAccesLeftExprContext *ctx){
    DEBUG_ENTER();
    visitChildren(ctx);
    visit(ctx->pair());
    TypesMgr::TypeId t = getTypeDecor(ctx->pair());
...
std::any TypeCheckVisitor::visitPair(AslParser::PairContext *ctx){
    DEBUG_ENTER();
    visit(ctx->ident());
    TypesMgr::TypeId tPair = getTypeDecor(ctx->ident());
