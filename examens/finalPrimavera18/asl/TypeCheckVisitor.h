...
public:
  ...
  std::any visitPairAccessExpr(AslParser::PairAccessExprContext *ctx);
  std::any visitPairAccesLeftExpr(AslParser::PairAccesLeftExprContext *ctx);
  std::any visitPair(AslParser::PairContext *ctx);
