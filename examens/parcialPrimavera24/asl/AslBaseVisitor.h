...
public:
  ...
  virtual std::any visitTryCatch(AslParser::TryCatchContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitThrow(AslParser::ThrowContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitLcases(AslParser::LcasesContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitArrayConstructorExpr(AslParser::ArrayConstructorExprContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitFunctionCall(AslParser::FunctionCallContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitArrayAccess(AslParser::ArrayAccessContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitArrayConstructor(AslParser::ArrayConstructorContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitLParams(AslParser::LParamsContext *ctx) override {
    return visitChildren(ctx);
  }
