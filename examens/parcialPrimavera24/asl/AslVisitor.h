...
public:
   ...
   */
    ...
    virtual std::any visitTryCatch(AslParser::TryCatchContext *context) = 0;
    ...
    virtual std::any visitThrow(AslParser::ThrowContext *context) = 0;

    virtual std::any visitLcases(AslParser::LcasesContext *context) = 0;
    ...
    virtual std::any visitArrayConstructorExpr(AslParser::ArrayConstructorExprContext *context) = 0;

    virtual std::any visitFunctionCall(AslParser::FunctionCallContext *context) = 0;
    ...
    virtual std::any visitArrayAccess(AslParser::ArrayAccessContext *context) = 0;

    virtual std::any visitLogic(AslParser::LogicContext *context) = 0;

    virtual std::any visitArrayConstructor(AslParser::ArrayConstructorContext *context) = 0;
    ...
    virtual std::any visitLParams(AslParser::LParamsContext *context) = 0;
