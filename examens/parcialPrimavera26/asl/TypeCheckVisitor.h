...
public:
  ...
  bool isStringOrChar(TypesMgr::TypeId type);
  std::any visitStringVal(AslParser::StringValContext *ctx);
  std::any visitIndexExpr(AslParser::IndexExprContext *ctx);
  std::any visitLenghtExpr(AslParser::LenghtExprContext *ctx);
  std::any visitInExpr(AslParser::InExprContext *ctx);
  std::any visitMapIterationStmt(AslParser::MapIterationStmtContext *ctx);
