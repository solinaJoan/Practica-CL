...
public:
   ...
   */
    ...
    virtual std::any visitAnycast(AslParser::AnycastContext *context) = 0;
    ...
    virtual std::any visitArrayNormal(AslParser::ArrayNormalContext *context) = 0;

    virtual std::any visitArraySlice(AslParser::ArraySliceContext *context) = 0;

    virtual std::any visitArrayMultiDim(AslParser::ArrayMultiDimContext *context) = 0;
