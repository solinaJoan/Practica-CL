...
public:
  ...
  enum {
    ...
    RuleExpr = 8, RuleArray = 9, RuleIdent = 10, RuleParams = 11, RuleLParams = 12
  };
  ...
  class  AnycastContext : public ExprContext {
  public:
    AnycastContext(ExprContext *ctx);

    antlr4::tree::TerminalNode *ANYCAST();
  ...
  class  ArrayNormalContext : public ArrayContext {
  public:
    ArrayNormalContext(ArrayContext *ctx);
  ...
  class  ArraySliceContext : public ArrayContext {
  public:
    ArraySliceContext(ArrayContext *ctx);
  ...
  class  ArrayMultiDimContext : public ArrayContext {
  public:
    ArrayMultiDimContext(ArrayContext *ctx);
