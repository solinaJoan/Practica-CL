...
public:
  ...
  virtual std::any visitAnycast(AslParser::AnycastContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitArrayNormal(AslParser::ArrayNormalContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitArraySlice(AslParser::ArraySliceContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitArrayMultiDim(AslParser::ArrayMultiDimContext *ctx) override {
    return visitChildren(ctx);
  }
