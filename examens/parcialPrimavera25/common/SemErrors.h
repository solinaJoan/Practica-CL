...
public:
  ...
  //   ctx is the node corresponding to the anycast
  void anyCastFromNonAny            (antlr4::ParserRuleContext *ctx);
  //   ctx is the node corresponding to an array slice
  void nonArrayInArraySlice         (antlr4::ParserRuleContext *ctx);
  //   ctx is the node corresponding to an array slice
  void invalidLimitsInSlice         (antlr4::ParserRuleContext *ctx);
